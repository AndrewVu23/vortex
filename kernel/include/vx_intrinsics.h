...
// Software Prefetch
// Custom opcode: %0 -> calls RISCV_CUSTOM0 0x0B
// funct_3 = 0 -> operands selector
// funct_7 = 5 -> group selector
// rd = x0 -> prefetch is read-only -> write is deleted
// rs1 = %1 -> calls addr for rs1
// rs2 = x0 -> unused in prefetch stage
