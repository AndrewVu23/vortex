...
When executing, Blackbox needs to recompile the driver if the desired architecture changes.
...
You can execute the default opencl suite by running the following commands at the root folder.
